...
type Provider interface {
	AddTransport(TTransport)
	RemoveTransport(TTransport)
...
type provider struct {
	...
	transports   map[TTransport]TTransport
...
func newProvider(tracer Tracer) *provider {
	...
	this.transports = make(map[TTransport]TTransport)
...
func (this *provider) AddTransport(t TTransport) {
	this.transports[t] = t
}

func (this *provider) RemoveTransport(t TTransport) {
